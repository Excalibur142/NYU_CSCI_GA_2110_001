...
interface SetOf<T> extends LessThanOrEqualTo, Iterable{
  public T get();
  public void add(T t);
  public boolean empty();
  public boolean member(T t);
  public <T extends SefOf> boolean subset(T other);
  public <T extends SefOf> T union (T other);
  public <T extends SefOf> T intersection (T other);
  public <T extends SefOf> T difference (T other);
